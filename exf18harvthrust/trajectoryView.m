function trajectoryView(time, ...
    ...
    plot3d_options.theView = [105, 12.5];
    ...
    hxL.Position(1) = hxL.Position(1) + x_max/2; hxL.Position(2) = hxL.Position(2) - y_max/8;
    hyL = ylabel("$y_{_\mathrm{E}}$ (m)", 'Interpreter', 'latex', 'FontSize', 18); hyL.Position(1) = hyL.Position(1) + x_max/10;
