function stackedPlot5(x, y1, y2, y3, y4, y5, labels, titles, lgnd, filename)
    h = figure;
    set(h, 'Position', get(0, 'MonitorPositions'))

    if isempty(lgnd) && isempty(titles)
        positions = [0.05, 0.82, 0.9, 0.17; ...
                     0.05, 0.655, 0.9, 0.17; ...
                     0.05, 0.47, 0.9, 0.17; ...
                     0.05, 0.265, 0.9, 0.17; ...
                     0.05, 0.05, 0.9, 0.17];
    elseif isempty(lgnd) && ~isempty(titles)
        positions = [0.05, 0.82, 0.9, 0.15; ...
                     0.05, 0.655, 0.9, 0.15; ...
                     0.05, 0.47, 0.9, 0.15; ...
                     0.05, 0.265, 0.9, 0.15; ...
                     0.05, 0.05, 0.9, 0.15];
    elseif ~isempty(lgnd) && isempty(titles)
        positions = [0.05, 0.82, 0.7, 0.17; ...
                     0.05, 0.655, 0.7, 0.17; ...
                     0.05, 0.47, 0.7, 0.17; ...
                     0.05, 0.265, 0.7, 0.17; ...
                     0.05, 0.05, 0.7, 0.17];
    else
        positions = [0.05, 0.82, 0.7, 0.15; ...
                     0.05, 0.655, 0.7, 0.15; ...
                     0.05, 0.47, 0.7, 0.15; ...
                     0.05, 0.265, 0.7, 0.15; ...
                     0.05, 0.05, 0.7, 0.15];
